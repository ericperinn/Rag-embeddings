...
def upsert_to_pinecone(id_prefix, vector, metadata):
    ...
    # Use hashed ID to avoid ASCII errors
...
def process_text_file(filepath):
    """Generates text embeddings for chunks of a text file."""
    ...
    for i, chunk in enumerate(chunks):
        ...
        upsert_to_pinecone(
            ...
            metadata={
                ...
                "source": filepath,
                "chunk_index": i,
                "content": chunk[:1000],  # Store more content in metadata for context
            },
        )
...
def process_pdf_file(filepath):
    """Extracts text from PDF, chunks it, and embeds each chunk."""
    import PyPDF2
...
def process_image_file(filepath):
    ...
    # gemini-embedding-2-preview is multimodal
    response = client.models.embed_content(
        model="gemini-embedding-2-preview",
        contents=img,
...
def process_video_file(filepath, interval_seconds=5):
    """Extracts keyframes and embeds them."""
